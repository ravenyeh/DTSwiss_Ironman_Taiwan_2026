...
// Update settings display on page load (inputs and banner)
...
// Parse structured workout with warmup/main/cooldown like "(熱身3km + 5km @ 5:30/km + 緩和2km)"
function parseStructuredWorkout(content) {
    // Pattern: 熱身Xkm + Ykm @ pace + 緩和Zkm
...
async function importWithToken(dayIndex) {
    ...
    // Now import using the session
    await importAllToGarmin(dayIndex);
}
